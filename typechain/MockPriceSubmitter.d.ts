...
interface MockPriceSubmitterInterface extends ethers.utils.Interface {
  functions: {
    ...
    "voterWhitelisted(address,uint256)": FunctionFragment;
    "votersRemovedFromWhitelist(address[],uint256)": FunctionFragment;
  };
...
export class MockPriceSubmitter extends BaseContract {
  ...
  interface: MockPriceSubmitterInterface;
