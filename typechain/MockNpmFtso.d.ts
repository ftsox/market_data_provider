...
interface MockNpmFtsoInterface extends ethers.utils.Interface {
  functions: {
    "ASSET_PRICE_USD_DECIMALS()": FunctionFragment;
    "activateFtso(address,uint256,uint256,uint256)": FunctionFragment;
    "active()": FunctionFragment;
    "assetFtsos(uint256)": FunctionFragment;
    ...
    "priceSubmitter()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "ASSET_PRICE_USD_DECIMALS",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "assetFtsos", data: BytesLike): Result;
...
export class MockNpmFtso extends BaseContract {
  ...
  interface: MockNpmFtsoInterface;

  functions: {
    ASSET_PRICE_USD_DECIMALS(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    priceSubmitter(overrides?: CallOverrides): Promise<[string]>;
    ...
    setAsset(arg0: string, overrides?: CallOverrides): Promise<[void]>;

    setAssetFtsos(arg0: string[], overrides?: CallOverrides): Promise<[void]>;
  ...
  assetFtsos(arg0: BigNumberish, overrides?: CallOverrides): Promise<string>;
  ...
  getEpochId(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  getRandom(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  estimateGas: {
    ...
    deactivateFtso(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    priceSubmitter(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    setAsset(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    deactivateFtso(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    priceSubmitter(overrides?: CallOverrides): Promise<PopulatedTransaction>;
