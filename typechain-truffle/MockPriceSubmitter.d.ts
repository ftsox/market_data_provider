...
export interface MockPriceSubmitterContract
  extends Truffle.Contract<MockPriceSubmitterInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<MockPriceSubmitterInstance>;
}
...
export interface MockPriceSubmitterInstance extends Truffle.ContractInstance {
