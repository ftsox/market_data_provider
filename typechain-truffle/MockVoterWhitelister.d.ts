...
export interface MockVoterWhitelisterContract
  extends Truffle.Contract<MockVoterWhitelisterInstance> {
  "new"(
    _priceSubmitter: string,
    meta?: Truffle.TransactionDetails
  ): Promise<MockVoterWhitelisterInstance>;
}
...
export interface MockVoterWhitelisterInstance extends Truffle.ContractInstance {
  addFtso: {
    (
  ...
  setFtsoRegistry: {
    (_ftsoRegistry: string, txDetails?: Truffle.TransactionDetails): Promise<
      Truffle.TransactionResponse<AllEvents>
    >;
    call(
